...
import ClientSlugError from "./ClientSlugError";
...
export const ErrorBoundary = () => {
  ...
  if (isRouteErrorResponse(error)) return <ClientSlugError status={error.status} statusText={error.statusText} />;
  if (error instanceof Error)
    return <ClientSlugError status={500} statusText={`Message: ${error.message}. Stack: ${error.stack}`} />;
