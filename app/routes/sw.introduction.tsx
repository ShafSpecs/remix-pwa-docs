          ...
          >
            ...
            <Grid>
              <CustomLink.default
                icon={<Arrow />}
                title={"Installation"}
                desc={"Set up your own Service Worker from scratch using @remix-pwa/sw!"}
              />
              <CustomLink.default
                icon={<Widget />}
                title={"Guide"}
                desc={"Explore the how-tos in this section and get familiar with the package."}
              />
              <CustomLink.default
                icon={<Plugin />}
                title={"Plugins"}
                desc={"Expand your Service Worker capabilities using plugins."}
              />
              <CustomLink.default
                icon={<Swatch />}
                title={"API Reference"}
                desc={"Dive right under the hood and explore in detail."}
              />
            </Grid>
...
export default function IndexRoute() {
  ...
  return (
    <ClientOnly fallback={<Skeleton />} children={() => <Index code={code} frontmatter={frontmatter} next={next} />} />
  );
}
