...
export default ({ className, fill }: { className: string; fill: string }) => {
  return (
    <svg
      width="800"
      height="800"
    ...
    >
      <path
        ...
        fill={fill}
      />
      <path d="M195 636V562.553H328.697C351.029 562.553 355.878 579.116 355.878 588.994V636H195Z" fill={fill} />
      <path
