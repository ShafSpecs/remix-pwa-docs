...
export default ({ children }: any) => {
  return (
    <div className="flex p-6 my-8 rounded-3xl bg-sky-50 dark:bg-slate-800/60 dark:ring-1 dark:ring-slate-300/10">
      <svg
        aria-hidden="true"
        viewBox="0 0 32 32"
        fill="none"
      ...
      <div className="flex-auto ml-4">
        <p className="m-0 text-xl font-display text-sky-900 dark:text-sky-400">
          You should know!
        </p>
