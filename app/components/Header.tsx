...
export default () => {
  ...
  return (
    <Fragment>
      <header
        id="header__main"
        className={clsx('sticky top-0 z-40 flex flex-wrap items-center justify-between bg-white px-4 py-4 shadow-slate-900/5 transition duration-300 dark:shadow-none sm:px-6 lg:px-8 w-full backdrop-blur lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06]',
          isOpaque
            ? 'bg-white supports-backdrop-blur:bg-white/95 dark:bg-slate-900/75 shadow-sm'
