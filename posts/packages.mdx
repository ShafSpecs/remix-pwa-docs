...
the ability to cache a response for a specific time.

## `@remix-pwa/sw`

The main factory house for Remix PWA. Ships with a lot less than v2 but still as important. Contains typings for the worker and utilities like hooks and
