...
**Please read this before attempting to make a contribution.**
...
4. An assignee (or multiple) would then be assigned to the issue. Who would keep track, and prepare the feature.
5. Once the feature is ready, a PR would then be opened and reviewing would happen.
6. If the green lght is given, a merge occurs!
