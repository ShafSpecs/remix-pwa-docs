---
title: Introduction
description: A lightweight, standalone npm package that adds full Progressive Web App support to Remix 💿. Let's dive in!
slug: /
...
- **Error handling is a nice-to-have**: Safely handles uncached loader calls without affecting other sections of the site (i.e Throws user to nearest Error boundary without disrupting Service Workers)
...
- **Plugins**: *Pssst*, that's right. Remix PWA extensibility just hit the next level 🔥. We are saying no more, as you would soon see! 
