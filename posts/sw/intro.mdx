...
description: "Explore the realms of Service Workers with Remix utilizing Remix PWA's very own extensible module!"
position: 1
---
...
<p className="lead">Get Remix PWA Service Workers up and running with this guide!</p>
...
<Grid>
  <Link
    ...
    to={"/sw#installation"}
    title={"Installation"}
    desc={"Set up `@remix-pwa/sw` in your application easily!"}
  />
  <Link
    icon={<Widget />}
    to={"/sw/basic-setup"}
