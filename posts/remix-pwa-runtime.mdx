...
If you want to create your own runtime, please refer to the source code of the [official runtime](https://github.com/remix-pwa/monorepo/blob/main/packages/worker-runtime/src/service-worker.internal.ts).
</Info>
