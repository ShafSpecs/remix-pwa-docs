...
- `assets`: A list of the assets the Remix app utilizes. In `development`, this is just the contents of the `public` folder. In `production` mode, it is the assets contained in the `buildDirectory`.
